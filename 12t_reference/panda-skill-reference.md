...
- **Dispatch / movement / hit box:** identical to Stasis Blow: same Wind Walker warp block (`Panda.cs:6768-6830`, 6 m / 16 m thresholds, refund beyond 16 m), same coroutine timeline (`$RPC_deathBlow$25547`, `:34851-35610`: speed 3 → 10 with target collision ignored → 4, yields 0.2/0.1/0.2/0.1/0.2 s, **4.7 m**), same box `FindRecTarget(pos − 2·forward, forward, 1+sf, 1+sf, (4+sf)·rangeMod, 2·rangeMod)` (`:35128`). `addTimeOut("deathBlow", agiAdjust(30))` (`:35421`).
