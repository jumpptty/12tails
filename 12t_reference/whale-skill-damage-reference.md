...
| `whale_honor` | Honor | 4 | [10, 15, 20, 25] MP, 15 SP (red) | 60s | 0s | 12s | Buff / Taunt (No Damage Formula) | — | Grants honor to all allies in 15m radius, adding +10×sLv to ATK, DEF, and CHA for 12s (`chaAdjusted`). Taunts enemies in 18+6×sLv meters. |
