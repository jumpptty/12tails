...
* **Validator:** `[CAO ERROR]`: 36 cooldown/duration/Perseverance/Revised Art cases against an independent brute force, known totals (Dark Edge 522 / 354, Lunar Eclipse 632 / 439), and the real mount (4 cards, toggle re-render, Ctrl+Z).
